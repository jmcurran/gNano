...
#'
#' @param model1LL.df data frame containing log likelihood from model 1 - comes from calcLogLik
#' @param model2LL.df data frame containing log likelihood from model 2 - comes from calcLogLik
#' @param model1lab optional label for model 1
#' @param model2lab optional label for model 2
#'
#' @return
#' @export
#'
#' @examples
compareLL = function(model1LL.df, model2LL.df, model1lab = NULL, model2lab = NULL){
