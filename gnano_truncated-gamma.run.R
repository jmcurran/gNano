...
sim.sample.truncated.gamma = coda.samples(model = sim, variable.names = parameters,
                          n.iter = 50000, thin = 50)
stats.truncated.gamma = summary(sim.sample.truncated.gamma)
save(sim.sample.truncated.gamma, stats.truncated, file = "James_truncated_gamma_model_results_2018_05_17.rda")
#stats
#plot(sim.sample)
